...
public class CommodityPricing {
	...
	public String toString() {
		return "CommodityPricing [cpId=" + cpId + ", cpCmId=" + cpCmId + ", cpUserId=" + cpUserId + ", cpLmId=" + cpLmId
				+ ", cpPrice=" + cpPrice + ", cpUnits=" + cpUnits + ", cpStatus=" + cpStatus + ", cpCreatedby="
				+ cpCreatedby + ", cpCreatedon=" + cpCreatedon + "]";
	}
